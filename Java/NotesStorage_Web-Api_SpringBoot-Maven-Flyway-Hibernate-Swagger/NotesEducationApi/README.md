...
<img src="docs/swagger-ui.png" width="820" alt="Swagger UI со списком эндпоинтов">
...
<img src="docs/swagger-post.png" width="820" alt="POST /api/v1/notes: тело запроса, код 201 и ответ с проставленным id">
...
<img src="docs/startup-log.png" width="820" alt="Лог запуска: Flyway накатывает миграции, затем стартует Hibernate">
